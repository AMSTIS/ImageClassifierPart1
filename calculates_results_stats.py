...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        ...
        label_index = 2
        if results_dic[key][label_index] == 1:
        ...
        # Pet Image Label is NOT a Dog
            ...
            # Classifier classifies image as NOT a Dog(& pet image isn't a dog)z
    ...
    results_stats_dic['pct_match'] = results_stats_dic['n_match'] / results_stats_dic['n_images'] * total_percentage
    ...
    results_stats_dic['pct_correct_dogs'] = (results_stats_dic['n_correct_dogs']/results_stats_dic['n_dogs_img'])*total_percentage
    ...
    results_stats_dic['pct_correct_breed'] = results_stats_dic['n_correct_breed'] / results_stats_dic['n_dogs_img'] * total_percentage

    # Calculates % correct not-a-dog images
    # Uses conditional statement for when no 'not a dog' images were submitted 
    if results_stats_dic['n_notdogs_img'] > 0:
        results_stats_dic['pct_correct_notdogs'] = (results_stats_dic['n_correct_notdogs'] /
                                                results_stats_dic['n_notdogs_img'])*total_percentage
    else:
